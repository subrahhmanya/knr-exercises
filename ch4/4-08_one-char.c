 ...
 *
 * Answer: Changing this was simple. Instead of a string for a buffer, only a
 * single char is needed. getch() needs a place to put the current value of the
 * buffer char so it can reset buf to zero. This is thankfully simple and cheap
 * to achieve.
 */
